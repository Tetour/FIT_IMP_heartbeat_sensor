...
Navigace v nastavení probíhá pomocí joysticku - nahoru/dolů pro výběr položky, doleva/doprava pro změnu hodnoty, střed pro potvrzení pro přechod na obrazovku zobrazení BPM.
...
\begin{figure}[H]
    ...
    \caption{Záznam šumu - signál bez detekce tepu}
    \label{fig:noise}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Záznam srdečního tepu - signál s detekcí tepu}
    \label{fig:heartbeat}
\end{figure}
